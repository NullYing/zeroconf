...
[![GoDoc](https://godoc.org/github.com/NullYing/zeroconf?status.svg)](https://godoc.org/github.com/NullYing/zeroconf)
[![Go Report Card](https://goreportcard.com/badge/github.com/NullYing/zeroconf)](https://goreportcard.com/report/github.com/NullYing/zeroconf)
[![Tests](https://github.com/NullYing/zeroconf/actions/workflows/go-test.yml/badge.svg)](https://github.com/NullYing/zeroconf/actions/workflows/go-test.yml)

## Install
Nothing is as easy as that:
```bash
$ go get -u github.com/NullYing/zeroconf
```
...
See https://github.com/NullYing/zeroconf/blob/master/examples/resolv/client.go.
...
See https://github.com/NullYing/zeroconf/blob/master/examples/register/server.go.
